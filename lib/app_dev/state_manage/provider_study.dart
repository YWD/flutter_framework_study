...
class ChangeNotifierProvider<T extends ChangeNotifier> extends StatefulWidget {
  ...
  static T of<T>(BuildContext context, {needUpdate = true}) {
    final provider =  needUpdate ? context.dependOnInheritedWidgetOfExactType<InheritedProvider<T>>()
...
class Consumer<T> extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var cart = ChangeNotifierProvider.of<T>(context);
